            ...
            sanphamInstance.methods.getsanphamAtIndex(row).call().then(function (addr) {
                sanphamInstance.methods.getCaygiong(addr).call().then(function (result) {
                    sanphamInstance.methods.getsanpham(addr).call().then(function (resultsanpham) {
                        ...
                        // console.log(result1);
                        if(resultsanpham[5]=="Chưa hoàn thành"){
                            table += `<tr>
                                        <td>
                                        <button class="btn btn-success btn-xs"
                                        data-toggle="modal" data-target="#InsertCaygiongform"
                                        onclick="insertcaygiong(\`` + result[0] + `\`)" >
...
//model update school
function frontUpdatecaygiong(address, tensanpham, khuvuctrong, nguoitrong, phanbon, thoivu,soluong,dientich, isLocked) {
    var table = "";
    table += `<tr>
                    <th>Address</th>
